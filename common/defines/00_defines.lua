...
NGame = {
	...
	GAME_SPEED_SECONDS = { 1000.0, 0.15, 0.10, 0.05, 0.0 }, -- game speeds for each level. Must be 5 entries with last one 0 for unbound
	...
	MISSION_REMOVE_FROM_INTERFACE_DEFAULT = 3,		-- Default days before a mission is removed from the interface after having failed or completed
...
NCountry = {
	...
	REINFORCEMENT_MANPOWER_DELIVERY_SPEED = 10,	-- Modifier for army manpower reinforcement delivery speed (travel time)
	...
	STARTING_COMMAND_POWER = 10,					-- starting command power for every country
	...
	SPECIAL_FORCES_CAP_MIN = 100000,					-- You can have a minimum of this many special forces battalions, regardless of the number of non-special forces battalions you have, this can also be modified by a country modifier
...
NProduction = {
	...
	MAX_MIL_FACTORIES_PER_LINE = 250,
	...
	BASE_FACTORY_EFFICIENCY_GAIN = 0.6,		-- Base efficiency factor.
	...
	MIN_POSSIBLE_TRAINING_MANPOWER = 10000000,	-- How many deployment lines minimum can be training
...
NBuildings = {
	...
	AIRBASE_CAPACITY_MULT = 500,		-- Each level of airbase building multiplied by this, gives capacity (max operational value). Value is int. 1 for each airplane.
	...
	NAVALBASE_REPAIR_MULT = 0.3,		-- Each level of navalbase building repairs X strength and can repair as many ships as its level
...
NDeployment = {
	BASE_DEPLOYMENT_TRAINING = 0.75,		-- Base training done each day during deployment.
},
...
NMilitary = {
	...
	CORPS_COMMANDER_DIVISIONS_CAP = 512,			-- how many divisions a corps commander is limited to. 0 = inf, < 0 = blocked
	...
	FIELD_MARSHAL_DIVISIONS_CAP = 512,			-- how many divisions a field marshall is limited to. 0 = inf, < 0 = blocked
	...
	LAND_AIR_COMBAT_STR_DAMAGE_MODIFIER = 0.045,    -- air global damage modifier
	LAND_AIR_COMBAT_ORG_DAMAGE_MODIFIER = 0.045,    -- global damage modifier
	...
	PREFERRED_TACTIC_COMMAND_POWER_COST = 5,	   -- command point cost for changing preferred tactic
	...
	BASE_LEADER_TRAIT_GAIN_XP = 0.1,			   -- Base xp gain for traits per hour for armies
	...
	PLAYER_ORDER_PLANNING_DECAY = 0.025,				-- Amount of planning lost due to player manual order
	PLANNING_GAIN = 0.005,
	...
	UNIT_LEADER_ASSIGN_TRAIT_COST = 0,					-- cost to assign a new trait to a unit leader
...
NAir = {
	...
	AIR_WING_BOMB_DAMAGE_FACTOR = 3.5,					-- Used to balance the damage done while bombing.
	...
	COMBAT_DAMAGE_STATS_MULTILPIER = 0.3,
	...
	BASE_STRATEGIC_BOMBING_HIT_PLANE_DAMAGE_FACTOR = 0.5,
	...
	ANTI_AIR_PLANE_DAMAGE_CHANCE = 0.05,					-- Anti Air Gun hit chance
	...
	ANTI_AIR_MAXIMUM_DAMAGE_REDUCTION_FACTOR = 0.55,	-- Maximum damage reduction factor applied to incoming air attacks against units with AA.
...
NNavy = {
	...
	SUPPLY_NEED_FACTOR = 1.5,										    -- multiplies supply usage
...
NRailwayGun = {
	RAILWAY_GUN_POSSIBLE_RANGES = { 50, 25, 65 },	-- Possible values for railway gun range in pixel.
	...
	OUT_OF_SUPPLY_SPEED = -0.2,						-- Max speed reduction from supply for railway guns
...
NAI = {
	...
	LAND_COMBAT_CAS_PER_ENEMY_ARMY = 50,				-- Amount of CAS planes requested per enemy division
...
NOperatives = {
	AGENCY_CREATION_DAYS = 15,						-- Number of days needed to create an intelligence agency
	AGENCY_UPGRADE_DAYS = 20,						-- Number of days needed to upgrade an intelligence agency
	...
	AGENCY_UPGRADE_PER_OPERATIVE_SLOT = 2,			-- Number of upgrade needed to unlock an additional operative slot
	MAX_OPERATIVE_SLOT_FROM_AGENCY_UPGRADES = 1,	-- max operative slots gained from upgrades
	AGENCY_OPERATIVE_RECRUITMENT_TIME = 10,			-- Number of days to wait to have operative to recruit when an operative slot first becomes available
	...
	OPERATIVE_BASE_INTEL_NETWORK_GAIN = 0.2,				-- Base amount of network strength gain per day provided by an operative
	...
	CRYPTO_CRYPTO_ACTIVE_BONUS_DURATION = 45,				-- number of days the active decryption bonuses will be applied before enemy resets their intelligence
...
NIntel = {
	...
	ARMY_INTEL_COMBAT_BONUS_MAX_BONUS = 0.1, -- max combat bonus that will apply when intel is high enough
